...
<body>
	...
	<div class="loginbox">
		...
		<form action="registration.php" method="post">
			...
			<input class="from-control" type="text" name="discountvalue" placeholder="İndirim miktarı giriniz" required>
	...
	<form>
		...
		<input class="from-control" type="text" name="discountvalue1" placeholder="İndirim miktarı giriniz" required="">

		<input class="btn btn-primary" type="submit" name="discount1" value="Seçili ürün için indirim yap">
		<?php
